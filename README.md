...
- Total: 76 bytes -> 104 chars Base58
...
To decrypt: same file, input 104 chars + password -> get seed 64 hex, then sweep to PQ wallet.
...
Therefore a new BIP is required. The community should agree on ONE canonical profile, e.g.:  KDF = Argon2id (t=3, m=64MB, p=1), ENC = AES-GCM-256 or ChaCha20-Poly1305, Format = Base58(salt||iv||ct).
