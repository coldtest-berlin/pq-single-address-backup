...
To decrypt: same file, input 103-105 chars + password -> get seed 64 hex, then sweep to PQ wallet.
...
- v1 (current, audit build): PBKDF2-HMAC-SHA256 200k + AES-GCM-256. Payload is salt 16 | iv 12 | ciphertext 48 = 76 bytes -> Base58 ∼103-105 chars. This version is intentionally minimal: pure WebCrypto, no dependencies, easy to audit. It shows the unencrypted seed in TEST MODE — for audit purposes only.
